# 1 "c:\\users\\hboyina.accelaops\\desktop\\pt-ferrari\\scripts\\construct_createrecord\\api_createrecord_milara\\\\combined_API_CreateRecord_MILARA.c"
...
# 1 "c:\\users\\hboyina.accelaops\\desktop\\pt-ferrari\\scripts\\construct_createrecord\\api_createrecord_milara\\\\combined_API_CreateRecord_MILARA.c" 2
...
# 2 "c:\\users\\hboyina.accelaops\\desktop\\pt-ferrari\\scripts\\construct_createrecord\\api_createrecord_milara\\\\combined_API_CreateRecord_MILARA.c" 2
...
# 3 "c:\\users\\hboyina.accelaops\\desktop\\pt-ferrari\\scripts\\construct_createrecord\\api_createrecord_milara\\\\combined_API_CreateRecord_MILARA.c" 2
...
vuser_init()
{
	...
	lr_start_transaction("Authentication_Milara");
...
web_set_sockets_option("IGNORE_PREMATURE_SHUTDOWN", "1");
	...
	status=web_custom_request("web_custom_request",
		"URL=http://10.106.21.51:3080/apis/v4/auth/agency",
		"Method=POST",
		"Resource=0",
		"Referer=",
		"Body={\"agency\": \"MILARA\",\"userId\": \"admin\",\"password\": \"admin\"}",
		"LAST");
...
lr_end_transaction("Authentication_Milara", 0);
	
	
	return 0;
}
# 4 "c:\\users\\hboyina.accelaops\\desktop\\pt-ferrari\\scripts\\construct_createrecord\\api_createrecord_milara\\\\combined_API_CreateRecord_MILARA.c" 2
...
status=web_custom_request("web_custom_request",
	...
	if(status==0)
	{
		lr_end_transaction("CreateRecord_Milara", 0);
		lr_output_message("Message: CreateRecord successful!");
	}
	else
	{
		lr_end_transaction("CreateRecord_Milara", 1);
...
# 5 "c:\\users\\hboyina.accelaops\\desktop\\pt-ferrari\\scripts\\construct_createrecord\\api_createrecord_milara\\\\combined_API_CreateRecord_MILARA.c" 2
...
# 6 "c:\\users\\hboyina.accelaops\\desktop\\pt-ferrari\\scripts\\construct_createrecord\\api_createrecord_milara\\\\combined_API_CreateRecord_MILARA.c" 2
