# 1 "c:\\users\\hboyina.accelaops\\desktop\\pt-ferrari\\construct\\api_createrecord_pasco\\\\combined_API_CreateRecord_PASCO.c"
...
# 1 "c:\\users\\hboyina.accelaops\\desktop\\pt-ferrari\\construct\\api_createrecord_pasco\\\\combined_API_CreateRecord_PASCO.c" 2
...
# 2 "c:\\users\\hboyina.accelaops\\desktop\\pt-ferrari\\construct\\api_createrecord_pasco\\\\combined_API_CreateRecord_PASCO.c" 2
...
# 3 "c:\\users\\hboyina.accelaops\\desktop\\pt-ferrari\\construct\\api_createrecord_pasco\\\\combined_API_CreateRecord_PASCO.c" 2
...
web_set_sockets_option("IGNORE_PREMATURE_SHUTDOWN", "1");
	...
	status=web_custom_request("web_custom_request",
		"URL=http://10.106.21.52:3080/apis/v4/auth/agency",
		"Method=POST",
		"Resource=0",
		"Referer=",
...
lr_end_transaction("Authentication_PASCO", 0);
	
	
	return 0;
}
# 4 "c:\\users\\hboyina.accelaops\\desktop\\pt-ferrari\\construct\\api_createrecord_pasco\\\\combined_API_CreateRecord_PASCO.c" 2
...
lr_start_transaction("CreateRecord_PASCO");
	...
	if(status==0)
	{
		lr_end_transaction("CreateRecord_PASCO", 0);
		lr_output_message("Message: CreateRecord successful!");
	}
	else
	{
		lr_end_transaction("CreateRecord_PASCO", 1);
...
# 5 "c:\\users\\hboyina.accelaops\\desktop\\pt-ferrari\\construct\\api_createrecord_pasco\\\\combined_API_CreateRecord_PASCO.c" 2
...
# 6 "c:\\users\\hboyina.accelaops\\desktop\\pt-ferrari\\construct\\api_createrecord_pasco\\\\combined_API_CreateRecord_PASCO.c" 2
