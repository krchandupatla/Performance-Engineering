...
//http://10.106.21.50:3080/apis/v4/auth/agency
////
//	 web_add_header("POST",	"http://10.106.21.50:3080/apis/v4/auth/LARA HTTP/1.1");
...
lr_end_transaction("Authentication_LARA", LR_PASS);
