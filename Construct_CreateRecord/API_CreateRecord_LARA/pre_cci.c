# 1 "c:\\users\\hboyina.accelaops\\desktop\\pt-ferrari\\scripts\\construct_createrecord\\api_createrecord_lara\\\\combined_API_CreateRecord_LARA.c"
...
# 1 "c:\\users\\hboyina.accelaops\\desktop\\pt-ferrari\\scripts\\construct_createrecord\\api_createrecord_lara\\\\combined_API_CreateRecord_LARA.c" 2
...
# 2 "c:\\users\\hboyina.accelaops\\desktop\\pt-ferrari\\scripts\\construct_createrecord\\api_createrecord_lara\\\\combined_API_CreateRecord_LARA.c" 2
...
# 3 "c:\\users\\hboyina.accelaops\\desktop\\pt-ferrari\\scripts\\construct_createrecord\\api_createrecord_lara\\\\combined_API_CreateRecord_LARA.c" 2
...
vuser_init()
{
	...
	lr_start_transaction("Authentication_LARA");
...
web_set_sockets_option("IGNORE_PREMATURE_SHUTDOWN", "1");
	...
	status=web_custom_request("web_custom_request",
		"URL=http://10.106.21.50:3080/apis/v4/auth/agency",
		"Method=POST",
		"Resource=0",
		"Referer=",
		"Body={\"agency\": \"LARA\",\"userId\": \"admin\",\"password\": \"admin\"}",
		"LAST");
...
lr_end_transaction("Authentication_LARA", 0);
	
	
	return 0;
}
# 4 "c:\\users\\hboyina.accelaops\\desktop\\pt-ferrari\\scripts\\construct_createrecord\\api_createrecord_lara\\\\combined_API_CreateRecord_LARA.c" 2
...
lr_start_transaction("CreateRecord_Lara");
	...
	if(status==0)
	{
		lr_end_transaction("CreateRecord_Lara", 0);
		lr_output_message("Message: CreateRecord successful!");
	}
	else
	{
		lr_end_transaction("CreateRecord_Lara", 1);
...
# 5 "c:\\users\\hboyina.accelaops\\desktop\\pt-ferrari\\scripts\\construct_createrecord\\api_createrecord_lara\\\\combined_API_CreateRecord_LARA.c" 2
...
# 6 "c:\\users\\hboyina.accelaops\\desktop\\pt-ferrari\\scripts\\construct_createrecord\\api_createrecord_lara\\\\combined_API_CreateRecord_LARA.c" 2
