# 1 "c:\\users\\hboyina.accelaops\\desktop\\pt-ferrari\\construct\\api_createrecord_osceola\\\\combined_API_CreateRecord_OSCEOLA.c"
...
# 1 "c:\\users\\hboyina.accelaops\\desktop\\pt-ferrari\\construct\\api_createrecord_osceola\\\\combined_API_CreateRecord_OSCEOLA.c" 2
...
# 2 "c:\\users\\hboyina.accelaops\\desktop\\pt-ferrari\\construct\\api_createrecord_osceola\\\\combined_API_CreateRecord_OSCEOLA.c" 2
...
# 3 "c:\\users\\hboyina.accelaops\\desktop\\pt-ferrari\\construct\\api_createrecord_osceola\\\\combined_API_CreateRecord_OSCEOLA.c" 2
...
vuser_init()
{
	...
	lr_start_transaction("Authentication_OSCEOLA");
...
web_set_sockets_option("IGNORE_PREMATURE_SHUTDOWN", "1");
	...
	status=web_custom_request("web_custom_request",
		"URL=http://10.106.21.55:3080/apis/v4/auth/agency",
		"Method=POST",
		"Resource=0",
		"Referer=",
		"Body={\"agency\": \"OSCEOLA\",\"userId\": \"admin\",\"password\": \"admin\"}",
		"LAST");
...
lr_end_transaction("Authentication_OSCEOLA", 0);
	
	
	return 0;
}
# 4 "c:\\users\\hboyina.accelaops\\desktop\\pt-ferrari\\construct\\api_createrecord_osceola\\\\combined_API_CreateRecord_OSCEOLA.c" 2
...
lr_start_transaction("CreateRecord_OSCEOLA");
	...
	if(status==0)
	{
		lr_end_transaction("CreateRecord_OSCEOLA", 0);
		lr_output_message("Message: CreateRecord successful!");
	}
	else
	{
		lr_end_transaction("CreateRecord_OSCEOLA", 1);
...
# 5 "c:\\users\\hboyina.accelaops\\desktop\\pt-ferrari\\construct\\api_createrecord_osceola\\\\combined_API_CreateRecord_OSCEOLA.c" 2
...
# 6 "c:\\users\\hboyina.accelaops\\desktop\\pt-ferrari\\construct\\api_createrecord_osceola\\\\combined_API_CreateRecord_OSCEOLA.c" 2
