# 1 "c:\\users\\hboyina.accelaops\\desktop\\pt-ferrari\\scripts\\milara\\milara_tc2\\\\combined_MILARA_TC2.c"
...
# 1 "c:\\users\\hboyina.accelaops\\desktop\\pt-ferrari\\scripts\\milara\\milara_tc2\\\\combined_MILARA_TC2.c" 2
...
# 2 "c:\\users\\hboyina.accelaops\\desktop\\pt-ferrari\\scripts\\milara\\milara_tc2\\\\combined_MILARA_TC2.c" 2
...
# 3 "c:\\users\\hboyina.accelaops\\desktop\\pt-ferrari\\scripts\\milara\\milara_tc2\\\\combined_MILARA_TC2.c" 2
...
# 4 "c:\\users\\hboyina.accelaops\\desktop\\pt-ferrari\\scripts\\milara\\milara_tc2\\\\combined_MILARA_TC2.c" 2
...
Action()
{
	...
	web_custom_request("loginAction.do", 
		"URL=https://av-pt-ferrari.accela.com/ssoAdapter/loginAction.do?requestType=checkWebSSOAdapter&servProvCode=mil", 
		"Method=GET", 
		"TargetFrame=", 
		"Resource=0", 
		"RecContentType=text/html", 
	...
	web_custom_request("loginAction.do_2", 
    ...
    web_add_header("AppD_Header", "MILARA_TC2_01_Click_Addresses");
	lr_start_transaction("MILARA_TC2_01_Click_Addresses");
	...
	web_url("session.do_5", 
		"URL=https://av-pt-ferrari.accela.com/portlets/spa/session.do?mode=activateSpace&spaceName=spaces.d3fc1", 
		"TargetFrame=", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=https://av-pt-ferrari.accela.com/portlets/spa/dashboard.do", 
	...
	web_url("session.do_6", 
		"URL=https://av-pt-ferrari.accela.com/portlets/spa/session.do?mode=activateSpace&spaceName=spaces.d3fc1&module=Licenses", 
		"TargetFrame=", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=https://av-pt-ferrari.accela.com/portlets/address/refAddressList.do?mode=Search", 
	...
	lr_end_transaction("MILARA_TC2_01_Click_Addresses",2);
    web_add_header("AppD_Header", "MILARA_TC2_02_Search_Addresses");
	lr_start_transaction("MILARA_TC2_02_Search_Addresses");
	...
	web_submit_data("refAddressList.do_2", 
		"Action=https://av-pt-ferrari.accela.com/portlets/address/refAddressList.do?module=Licenses", 
		"Method=POST", 
		"TargetFrame=", 
		"RecContentType=text/html", 
		"Referer=https://av-pt-ferrari.accela.com/portlets/address/refAddressList.do?mode=Search", 
		...
		"Name=CurrentViewID", "Value=31", "ENDITEM", 
		"Name=sessionIdFromWindow", "Value=rOvEQwaAcy+vrg42A7xJX+zy", "ENDITEM", 
		...
		"Name=value(address template)", "Value=", "ENDITEM", 
		"Name=isDaily", "Value=false", "ENDITEM", 
		"Name=value(state)", "Value=MI", "ENDITEM", 
		"Name=value(address template)", "Value=", "ENDITEM", 
		"Name=isDaily", "Value=false", "ENDITEM", 
	...
	web_url("session.do_10", 
		...
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=https://av-pt-ferrari.accela.com/portlets/address/refAddressList.do?module=Licenses", 
		"Snapshot=t26.inf", 
		"Mode=HTML", 
		"LAST");

	lr_end_transaction("MILARA_TC2_02_Search_Addresses",2);
    web_add_header("AppD_Header", "MILARA_TC2_03_Click_Parcel");
	lr_start_transaction("MILARA_TC2_03_Click_Parcel");
	...
	web_url("session.do_15", 
		"URL=https://av-pt-ferrari.accela.com/portlets/spa/session.do?mode=activateSpace&spaceName=spaces.d3fc2", 
		"TargetFrame=", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=https://av-pt-ferrari.accela.com/portlets/spa/dashboard.do", 
	...
	web_url("session.do_16", 
		"URL=https://av-pt-ferrari.accela.com/portlets/spa/session.do?mode=activateSpace&spaceName=spaces.d3fc2&module=Licenses", 
		"TargetFrame=", 
		"Resource=0", 
		"RecContentType=application/json", 
	...
	lr_end_transaction("MILARA_TC2_03_Click_Parcel",2);

	lr_think_time(4);
    web_add_header("AppD_Header", "MILARA_TC2_04_Search_Parcel");
	lr_start_transaction("MILARA_TC2_04_Search_Parcel");
	...
	web_submit_data("refParcelList.do_2", 
		"Action=https://av-pt-ferrari.accela.com/portlets/parcel/refParcelList.do?module=Licenses", 
		"Method=POST", 
		"TargetFrame=", 
		"RecContentType=text/html", 
		"Referer=https://av-pt-ferrari.accela.com/portlets/parcel/refParcelList.do?mode=search&lookup=false", 
	...
	lr_end_transaction("MILARA_TC2_04_Search_Parcel",2);
    web_add_header("AppD_Header", "MILARA_TC2_05_Click_Owner");
	lr_start_transaction("MILARA_TC2_05_Click_Owner");
	...
	web_url("session.do_18", 
		...
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=https://av-pt-ferrari.accela.com/portlets/parcel/refParcelList.do?module=Licenses", 
		"Snapshot=t39.inf", 
		"Mode=HTML", 
		"LAST");
	...
	web_url("session.do_22", 
		"URL=https://av-pt-ferrari.accela.com/portlets/spa/session.do?mode=activateSpace&spaceName=spaces.d3fc3", 
		"TargetFrame=", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=https://av-pt-ferrari.accela.com/portlets/spa/dashboard.do", 
	...
	web_url("session.do_23", 
		"URL=https://av-pt-ferrari.accela.com/portlets/spa/session.do?mode=activateSpace&spaceName=spaces.d3fc3&module=Licenses", 
		"TargetFrame=", 
		"Resource=0", 
		"RecContentType=application/json", 
	...
	lr_end_transaction("MILARA_TC2_05_Click_Owner",2);

	lr_think_time(4);
    web_add_header("AppD_Header", "MILARA_TC2_06_Search_Owner");
	lr_start_transaction("MILARA_TC2_06_Search_Owner");
	...
	web_submit_data("refOwnerList.do_2", 
		"Action=https://av-pt-ferrari.accela.com/portlets/owner/refOwnerList.do?module=Licenses", 
		"Method=POST", 
		"TargetFrame=", 
		"RecContentType=text/html", 
		"Referer=https://av-pt-ferrari.accela.com/portlets/owner/refOwnerList.do?mode=search", 
		...
		"Mode=HTML", 
		"ITEMDATA", 
		"Name=TRANSACTION_TOKEN_KEY_FOR_REFOWNERLIST", "Value=4347c29e973cc993bd3c9c7d07a1a5a7", "ENDITEM", 
		...
		"Name=printType", "Value=", "ENDITEM", 
		"Name=checkBoxValue", "Value=", "ENDITEM", 
		"Name=value(refOwner*ownerFullName)", "Value=perf", "ENDITEM", 
	...
	web_custom_request("refOwnerForm.do", 
		"URL=https://av-pt-ferrari.accela.com/portlets/owner/refOwnerForm.do?mode=viewCondition&module=Licenses&refOwnerNumber=932814332", 
		"Method=POST", 
		"TargetFrame=", 
		"Resource=0", 
		"RecContentType=text/html", 
		"Referer=https://av-pt-ferrari.accela.com/portlets/owner/refOwnerList.do?module=Licenses", 
		"Snapshot=t52.inf", 
		"Mode=HTML", 
		"Body=TRANSACTION_TOKEN_KEY_FOR_REFOWNERLIST=4347c29e973cc993bd3c9c7d07a1a5a7&value(FirstEntryURL)=%2Fportlets%2Fowner%2FrefOwnerList.do%3Fmode%3Dsearch&value(CurrentEntryURL)=%2Fportlets%2Fowner%2FrefOwnerList.do%3Fmodule%3DLicenses&portlet_language=en_US&refresh_target=&refresh_url=&buttonName=submit&modeName=searchresult&module=Licenses&accelasubmitbuttonname=&itemName=&CurrentViewID=20027&exceptionLogID=&generalCAPSearch=&objectName=owners&CheckBoxName=&MaxNumber=&ExportFileType=print&"
		"CurrentViewID=20027&sessionIdFromWindow=rOvEQwaAcy%2Bvrg42A7xJX%2Bzy&listID=&printType=&checkBoxValue=&isDynaPaging=true&page-navigator-input-id=1&932814332=PERF%20TESTING&pageSizeR=10&", 
		"LAST");

	lr_end_transaction("MILARA_TC2_06_Search_Owner",2);

	lr_think_time(4);
    web_add_header("AppD_Header", "MILARA_TC2_07_Click_LicenseProfessionals");
	lr_start_transaction("MILARA_TC2_07_Click_LicenseProfessionals");
	...
	web_url("session.do_30", 
		"URL=https://av-pt-ferrari.accela.com/portlets/spa/session.do?mode=activateSpace&spaceName=spaces.d3fc4", 
		"TargetFrame=", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=https://av-pt-ferrari.accela.com/portlets/spa/dashboard.do", 
	...
	lr_end_transaction("MILARA_TC2_07_Click_LicenseProfessionals",2);

	lr_think_time(7);
    web_add_header("AppD_Header", "MILARA_TC2_08_Click_LicenseProfessionals_SearchTab");
	lr_start_transaction("MILARA_TC2_08_Click_LicenseProfessionals_SearchTab");

	web_url("session.do_31", 
		"URL=https://av-pt-ferrari.accela.com/portlets/spa/session.do?mode=activateSpace&spaceName=spaces.d3fc4&module=Licenses", 
		"TargetFrame=", 
		"Resource=0", 
		"RecContentType=application/json", 
	...
	web_url("refProfessionalList.do_2", 
		"URL=https://av-pt-ferrari.accela.com/portlets/professional/ref/refProfessionalList.do?value(mode)=search&module=Licenses", 
		"TargetFrame=", 
		"Resource=0", 
		"RecContentType=text/html", 
		"Referer=https://av-pt-ferrari.accela.com/portlets/professional/ref/refProfessionalList.do?mode=quickQuery&lookup=false", 
	...
	web_submit_data("ajax.do", 
		...
		"TargetFrame=", 
		"RecContentType=text/html", 
		"Referer=https://av-pt-ferrari.accela.com/portlets/professional/ref/refProfessionalList.do?value(mode)=search&module=Licenses", 
		"Snapshot=t63.inf", 
		"Mode=HTML", 
		"ITEMDATA", 
		"LAST");
	...
	lr_end_transaction("MILARA_TC2_08_Click_LicenseProfessionals_SearchTab",2);

	lr_think_time(8);
    web_add_header("AppD_Header", "MILARA_TC2_09_Search_LicenseProfessionals_Submit");
	lr_start_transaction("MILARA_TC2_09_Search_LicenseProfessionals_Submit");
	...
	web_submit_data("refProfessionalList.do_3", 
		"Action=https://av-pt-ferrari.accela.com/portlets/professional/ref/refProfessionalList.do?module=Licenses", 
		"Method=POST", 
		"TargetFrame=", 
		"RecContentType=text/html", 
		"Referer=https://av-pt-ferrari.accela.com/portlets/professional/ref/refProfessionalList.do?value(mode)=search&module=Licenses", 
		...
		"Mode=HTML", 
		"ITEMDATA", 
		"Name=TRANSACTION_TOKEN_KEY_FOR_REFPROFESSIONALLISTACTIONFORM", "Value=dc45748c2da8291f8f6ff2c01a60f40c", "ENDITEM", 
		"Name=value(FirstEntryURL)", "Value=/portlets/professional/ref/refProfessionalList.do?value(mode)=search&module=Licenses", "ENDITEM", 
		"Name=value(CurrentEntryURL)", "Value=/portlets/professional/ref/refProfessionalList.do?value(mode)=search&module=Licenses", "ENDITEM", 
		"Name=portlet_language", "Value=en_US", "ENDITEM", 
		"Name=refresh_target", "Value=", "ENDITEM", 
		"Name=refresh_url", "Value=", "ENDITEM", 
		"Name=buttonName", "Value=", "ENDITEM", 
		...
		"Name=isFilterContactAssociatedLP", "Value=null", "ENDITEM", 
		"Name=value(stateLicense)", "Value=4704258394", "ENDITEM", 
		"Name=none", "Value=", "ENDITEM", 
		"Name=isFilterContactAssociatedLP", "Value=null", "ENDITEM", 
		"Name=value(auditstatus)", "Value=", "ENDITEM", 
		"Name=none", "Value=", "ENDITEM", 
		...
		"Name=value(mode)", "Value=list", "ENDITEM", 
		"Name=valuetextarea20", "Value=", "ENDITEM", 
		"Name=sourcetextarea20", "Value=", "ENDITEM", 
		"Name=layouttextarea20", "Value=", "ENDITEM", 
		"Name=uiuid", "Value=20", "ENDITEM", 
	...
	web_url("session.do_33", 
		...
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=https://av-pt-ferrari.accela.com/portlets/professional/ref/refProfessionalList.do?module=Licenses", 
		"Snapshot=t70.inf", 
		"Mode=HTML", 
		"LAST");

	lr_end_transaction("MILARA_TC2_09_Search_LicenseProfessionals_Submit",2);

	lr_think_time(5);
    web_add_header("AppD_Header", "MILARA_TC2_10_Click_Contacts");
	lr_start_transaction("MILARA_TC2_10_Click_Contacts");
	...
	web_url("session.do_38", 
		"URL=https://av-pt-ferrari.accela.com/portlets/spa/session.do?mode=activateSpace&spaceName=spaces.d3fc5", 
		"TargetFrame=", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=https://av-pt-ferrari.accela.com/portlets/spa/dashboard.do", 
	...
	web_url("refContactList.do", 
		"URL=https://av-pt-ferrari.accela.com/portlets/contact/ref/refContactList.do?mode=quickQuery&lookup=false&value(usedQueryInfo)=Y&serviceProviderCode=MILARA", 
		"TargetFrame=", 
		"Resource=0", 
		"RecContentType=text/html", 
	...
	lr_end_transaction("MILARA_TC2_10_Click_Contacts",2);

	lr_think_time(8);
    web_add_header("AppD_Header", "MILARA_TC2_11_Click_Search_Contacts_Tab");
	lr_start_transaction("MILARA_TC2_11_Click_Search_Contacts_Tab");

	web_url("session.do_39", 
		"URL=https://av-pt-ferrari.accela.com/portlets/spa/session.do?mode=activateSpace&spaceName=spaces.d3fc5&module=Licenses", 
		"TargetFrame=", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=https://av-pt-ferrari.accela.com/portlets/contact/ref/refContactList.do?mode=quickQuery&lookup=false&value(usedQueryInfo)=Y&serviceProviderCode=MILARA", 
		"Snapshot=t79.inf", 
		"Mode=HTML", 
		"LAST");

	web_url("refContactList.do_2", 
		"URL=https://av-pt-ferrari.accela.com/portlets/contact/ref/refContactList.do?value(mode)=search&value(lookup)=false&value(usedQueryInfo)=Y&module=Licenses", 
		"TargetFrame=", 
		"Resource=0", 
		"RecContentType=text/html", 
		"Referer=https://av-pt-ferrari.accela.com/portlets/contact/ref/refContactList.do?mode=quickQuery&lookup=false&value(usedQueryInfo)=Y&serviceProviderCode=MILARA", 
	...
	web_submit_data("ajax.do_2", 
		...
		"TargetFrame=", 
		"RecContentType=text/html", 
		"Referer=https://av-pt-ferrari.accela.com/portlets/contact/ref/refContactList.do?value(mode)=search&value(lookup)=false&value(usedQueryInfo)=Y&module=Licenses", 
		"Snapshot=t81.inf", 
		"Mode=HTML", 
		"ITEMDATA", 
		"LAST");
	...
	lr_end_transaction("MILARA_TC2_11_Click_Search_Contacts_Tab",2);

	lr_think_time(5);
    web_add_header("AppD_Header", "MILARA_TC2_12_Search_Contacts_Submit");
	lr_start_transaction("MILARA_TC2_12_Search_Contacts_Submit");
	...
	web_submit_data("refContactList.do_3", 
		"Action=https://av-pt-ferrari.accela.com/portlets/contact/ref/refContactList.do?module=Licenses", 
		"Method=POST", 
		"TargetFrame=", 
		"RecContentType=text/html", 
		"Referer=https://av-pt-ferrari.accela.com/portlets/contact/ref/refContactList.do?value(mode)=search&value(lookup)=false&value(usedQueryInfo)=Y&module=Licenses", 
		...
		"Mode=HTML", 
		"ITEMDATA", 
		"Name=TRANSACTION_TOKEN_KEY_FOR_REFCONTACTLISTACTIONFORM", "Value=c5dfcd18f050912da68dd123e6c156db", "ENDITEM", 
		"Name=value(FirstEntryURL)", "Value=/portlets/contact/ref/refContactList.do?value(mode)=search&value(lookup)=false&value(usedQueryInfo)=Y&module=Licenses", "ENDITEM", 
		"Name=value(CurrentEntryURL)", "Value=/portlets/contact/ref/refContactList.do?value(mode)=search&value(lookup)=false&value(usedQueryInfo)=Y&module=Licenses", "ENDITEM", 
		"Name=portlet_language", "Value=en_US", "ENDITEM", 
		"Name=refresh_target", "Value=", "ENDITEM", 
		"Name=refresh_url", "Value=", "ENDITEM", 
		"Name=buttonName", "Value=", "ENDITEM", 
		...
		"Name=value(title)", "Value=", "ENDITEM", 
		"Name=value(firstName)", "Value=SHARON", "ENDITEM", 
		...
		"Name=value(contactSeqNumber)", "Value=", "ENDITEM", 
		"Name=isShowContactAddressFields", "Value=Y", "ENDITEM", 
		"Name=valuetextarea21", "Value=", "ENDITEM", 
		"Name=sourcetextarea21", "Value=", "ENDITEM", 
		"Name=layouttextarea21", "Value=", "ENDITEM", 
		"Name=uiuid", "Value=21", "ENDITEM", 
		"Name=_viewstate_", "Value={\"empty\":false,\"fields\":{\"value(fein)\":{\"maskValue\":\"\",\"originalValue\":\"\",\"strategy\":\"FEIN\"},\"value(socialSecurityNumber)\":{\"maskValue\":\"\",\"originalValue\":\"\",\"strategy\":\"SSN\"}}}", "ENDITEM", 
		"LAST");
	...
	lr_end_transaction("MILARA_TC2_12_Search_Contacts_Submit",2);
	...
	web_url("session.do_41", 
		...
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=https://av-pt-ferrari.accela.com/portlets/contact/ref/refContactList.do?module=Licenses", 
		"Snapshot=t91.inf", 
		"Mode=HTML", 
		"LAST");
...
# 5 "c:\\users\\hboyina.accelaops\\desktop\\pt-ferrari\\scripts\\milara\\milara_tc2\\\\combined_MILARA_TC2.c" 2
...
# 6 "c:\\users\\hboyina.accelaops\\desktop\\pt-ferrari\\scripts\\milara\\milara_tc2\\\\combined_MILARA_TC2.c" 2
