# 1 "c:\\users\\hboyina.accelaops\\desktop\\pt-ferrari\\scripts\\milwaukee\\milwaukee_tc1\\\\combined_MILWAUKEE_TC1.c"
...
# 1 "c:\\users\\hboyina.accelaops\\desktop\\pt-ferrari\\scripts\\milwaukee\\milwaukee_tc1\\\\combined_MILWAUKEE_TC1.c" 2
...
# 2 "c:\\users\\hboyina.accelaops\\desktop\\pt-ferrari\\scripts\\milwaukee\\milwaukee_tc1\\\\combined_MILWAUKEE_TC1.c" 2
...
# 3 "c:\\users\\hboyina.accelaops\\desktop\\pt-ferrari\\scripts\\milwaukee\\milwaukee_tc1\\\\combined_MILWAUKEE_TC1.c" 2
...
# 4 "c:\\users\\hboyina.accelaops\\desktop\\pt-ferrari\\scripts\\milwaukee\\milwaukee_tc1\\\\combined_MILWAUKEE_TC1.c" 2
...
Action()
{
	...
	lr_think_time(7);
    web_add_header("AppD_Header", "MILWAUKEE_TC1_01_Click_Record");
	lr_start_transaction("MILWAUKEE_TC1_01_Click_Record");
	...
	web_url("session.do_5", 
		"URL=https://av-pt-ferrari.accela.com/portlets/spa/session.do?mode=activateSpace&spaceName=spaces.d2f61", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=https://av-pt-ferrari.accela.com/portlets/spa/dashboard.do", 
		"Snapshot=t12.inf", 
	...
	lr_end_transaction("MILWAUKEE_TC1_01_Click_Record",2);
    web_add_header("AppD_Header", "MILWAUKEE_TC1_02_Click_Search");
	lr_start_transaction("MILWAUKEE_TC1_02_Click_Search");

	web_url("session.do_6", 
		"URL=https://av-pt-ferrari.accela.com/portlets/spa/session.do?mode=activateSpace&spaceName=spaces.d2f61&module=Building", 
		"Resource=0", 
		"RecContentType=application/json", 
	...
	lr_end_transaction("MILWAUKEE_TC1_02_Click_Search",2);

	lr_think_time(13);
    web_add_header("AppD_Header", "MILWAUKEE_TC1_03_Search_Record");
	lr_start_transaction("MILWAUKEE_TC1_03_Search_Record");
	...
	web_submit_data("capSearch.do_2", 
		...
		"Mode=HTML", 
		"ITEMDATA", 
		"Name=TRANSACTION_TOKEN_KEY_FOR_CAPSEARCHFORM", "Value=4cace1510f50082b1ccff2a61850331d", "ENDITEM", 
		...
		"Name=CurrentViewID", "Value=115", "ENDITEM", 
		"Name=sessionIdFromWindow", "Value=aOc5j0hRkbuBd1nrp-zU1kBF", "ENDITEM", 
		...
		"Name=value(capModel*altID)", "Value=CHK-18-00017", "ENDITEM", 
		...
		"Name=date(capModel*fileDate)", "Value=09/10/1993", "ENDITEM", 
		"Name=date(capModel*endFileDate)", "Value=09/04/2018", "ENDITEM", 
	...
	lr_end_transaction("MILWAUKEE_TC1_03_Search_Record",2);
    web_add_header("AppD_Header", "MILWAUKEE_TC1_04_Record_Details");
	lr_start_transaction("MILWAUKEE_TC1_04_Record_Details");
	...
	web_url("CapTabSummary.do",
		"URL=https://av-pt-ferrari.accela.com/portlets/cap/capsummary/CapTabSummary.do?mode=tabSummary&serviceProviderCode=MILWAUKEE&ID1=18CAP&ID2=00000&ID3={Param_ID3}&requireNotice=YES&clearForm=clearForm&module=Licenses&isFromCapList=true&isGeneralCAP=Y",
		"Resource=0",
		"RecContentType=text/html",
		"Referer=https://av-pt-ferrari.accela.com/portlets/cap/capSearch.do?module=Building",
		"Snapshot=t23.inf",
	...
	web_submit_data("ajax.do",
		...
		"Method=POST",
		"RecContentType=text/html",
		"Referer=https://av-pt-ferrari.accela.com/portlets/cap/capsummary/CapTabSummary.do?mode=tabSummary&serviceProviderCode=MILWAUKEE&ID1=18CAP&ID2=00000&ID3={Param_ID3}&requireNotice=YES&clearForm=clearForm&module=Licenses&isFromCapList=true&isGeneralCAP=Y",
		"Snapshot=t25.inf",
		"Mode=HTML",
		"ITEMDATA",
		"LAST");
	...
	web_custom_request("tabRecordCount.do",
		"URL=https://av-pt-ferrari.accela.com/portlets/cap/tabRecordCount.do?module=Licenses&ID1=18CAP&ID2=00000&ID3={Param_ID3}&xmlin=%3Croot%3E%3CcountID%3E18%3C/countID%3E%3C/root%3E",
		"Method=GET",
		"Resource=0",
	...
	web_custom_request("tabRecordCount.do_2",
		"URL=https://av-pt-ferrari.accela.com/portlets/cap/tabRecordCount.do?module=Licenses&ID1=18CAP&ID2=00000&ID3={Param_ID3}&xmlin=%3Croot%3E%3CcountID%3E5%3C/countID%3E%3CcountID%3E6%3C/countID%3E%3CcountID%3E2%3C/countID%3E%3CcountID%3E134%3C/countID%3E%3CcountID%3E16%3C/countID%3E%3CcountID%3E23%3C/countID%3E%3CcountID%3E17%3C/countID%3E%3CcountID%3E397%3C/countID%3E%3CcountID%3E1%3C/countID%3E%3CcountID%3E378%3C/countID%3E%3CcountID%3E21%3C/countID%3E%3CcountID%3E226%3C/countID%3E%3CcountID%3E372%3C/countID%3E%3CcountID%3E24%3C/countID%3E%3CcountID%3E379%3C/countID%3E%3CcountID%3E10%3C/countID%3E%3CcountID%3E133%3C/countID%3E%3CcountID%3E8%3C/countID%3E%3CcountID%3E19%3C/countID%3E%3CcountID%3E373%3C/countID%3E%3CcountID%3E14%3C/countID%3E%3CcountID%3E12%3C/countID%3E%3CcountID%3E13%3C/countID%3E%3CcountID%3E371%3C/countID%3E%3CcountID%3E27%3C/countID%3E%3CcountID%3E360%3C/countID%3E%3CcountID%3E3%3C/countID%3E%3CcountID%3E152%3C/countID%3E%3CcountID%3E303%3C/countID%3E%3CcountID%3E4%3C/countID%3E%3C/root%3E",
		"Method=GET",
		"Resource=0",
		"RecContentType=text/xml",
		"Referer=https://av-pt-ferrari.accela.com/portlets/cap/capsummary/CapTabSummary.do?mode=tabSummary&serviceProviderCode=MILWAUKEE&ID1=18CAP&ID2=00000&ID3={Param_ID3}&requireNotice=YES&clearForm=clearForm&module=Licenses&isFromCapList=true&isGeneralCAP=Y",
	...
	web_submit_data("expression.do",
		...
		"Mode=HTML",
		"ITEMDATA",
		"Name=argumentPKs", "Value=[{\"portletID\":-1,\"viewKey1\":\"\",\"viewKey2\":\"\",\"viewKey3\":\"\"},{\"portletID\":-2,\"viewKey1\":\"\",\"viewKey2\":\"\",\"viewKey3\":\"\"}]", "ENDITEM",
		"Name=expressionPageType", "Value=SINGLEPORTLET", "ENDITEM",
		"Name=isReload", "Value=false", "ENDITEM",
		"Name=module", "Value=Licenses", "ENDITEM",
		"Name=capType", "Value=Licenses/Residential/Chicken/NA", "ENDITEM",
		"LAST");
	...
	lr_end_transaction("MILWAUKEE_TC1_04_Record_Details",2);
	...
	web_url("session.do_11",
		"URL=https://av-pt-ferrari.accela.com/portlets/spa/session.do?mode=activateSpace&spaceName=spaces.d2f61&module=Licenses",
		"Resource=0",
		"RecContentType=application/json",
		"Referer=https://av-pt-ferrari.accela.com/portlets/cap/capsummary/CapTabSummary.do?mode=tabSummary&serviceProviderCode=MILWAUKEE&ID1=18CAP&ID2=00000&ID3={Param_ID3}&requireNotice=YES&clearForm=clearForm&module=Licenses&isFromCapList=true&isGeneralCAP=Y",
		"Snapshot=t33.inf",
	...
	lr_think_time(6);
    web_add_header("AppD_Header", "MILWAUKEE_TC1_05_Click_Addtl_Info");
	lr_start_transaction("MILWAUKEE_TC1_05_Click_Addtl_Info");
	...
	lr_end_transaction("MILWAUKEE_TC1_05_Click_Addtl_Info",2);

	lr_think_time(8);
    web_add_header("AppD_Header", "MILWAUKEE_TC1_06_Save_Addtl_Info");
	lr_start_transaction("MILWAUKEE_TC1_06_Save_Addtl_Info");
	...
	web_submit_data("addtInfoForm.do_2",
		...
		"Name=value(capDetailModel*buildingCount)", "Value=2", "ENDITEM",
		"Name=value(capDetailModel*houseCount)", "Value=2", "ENDITEM",
		"Name=value(capDetailModel*constTypeCode)", "Value=101", "ENDITEM",
		"Name=value(capDetailModel*publicOwned)", "Value=Y", "ENDITEM",
		"LAST");
	...
	lr_end_transaction("MILWAUKEE_TC1_06_Save_Addtl_Info",2);

	lr_think_time(25);
    web_add_header("AppD_Header", "MILWAUKEE_TC1_07_Click_ActivitySummury");
	lr_start_transaction("MILWAUKEE_TC1_07_Click_ActivitySummury");
	...
	web_url("activitySummaryList.do", 
		"URL=https://av-pt-ferrari.accela.com/portlets/activity/activitySummaryList.do?module=Licenses", 
		"Resource=0", 
		"RecContentType=text/html", 
		"Referer=https://av-pt-ferrari.accela.com/portlets/addtinfo/addtInfoForm.do?module=Licenses", 
		"Snapshot=t45.inf", 
	...
	web_custom_request("tabRecordCount.do_7",
		...
		"Resource=0",
		"RecContentType=text/xml",
		"Referer=https://av-pt-ferrari.accela.com/portlets/activity/activitySummaryList.do?module=Licenses",
		"Snapshot=t47.inf",
		"Mode=HTML",
		"EncType=txt/xml",
		"LAST");
	...
	lr_end_transaction("MILWAUKEE_TC1_07_Click_ActivitySummury",2);

	lr_think_time(9);
    web_add_header("AppD_Header", "MILWAUKEE_TC1_08_Click_WorkFlow");
	lr_start_transaction("MILWAUKEE_TC1_08_Click_WorkFlow");
	...
	lr_end_transaction("MILWAUKEE_TC1_08_Click_WorkFlow",2);
...
# 5 "c:\\users\\hboyina.accelaops\\desktop\\pt-ferrari\\scripts\\milwaukee\\milwaukee_tc1\\\\combined_MILWAUKEE_TC1.c" 2
...
# 6 "c:\\users\\hboyina.accelaops\\desktop\\pt-ferrari\\scripts\\milwaukee\\milwaukee_tc1\\\\combined_MILWAUKEE_TC1.c" 2
