# 1 "c:\\users\\hboyina.accelaops\\desktop\\pt-ferrari\\scripts\\milwaukee\\milwaukee_tc2\\\\combined_MILWAUKEE_TC2.c"
...
# 1 "c:\\users\\hboyina.accelaops\\desktop\\pt-ferrari\\scripts\\milwaukee\\milwaukee_tc2\\\\combined_MILWAUKEE_TC2.c" 2
...
# 2 "c:\\users\\hboyina.accelaops\\desktop\\pt-ferrari\\scripts\\milwaukee\\milwaukee_tc2\\\\combined_MILWAUKEE_TC2.c" 2
...
# 3 "c:\\users\\hboyina.accelaops\\desktop\\pt-ferrari\\scripts\\milwaukee\\milwaukee_tc2\\\\combined_MILWAUKEE_TC2.c" 2
...
# 4 "c:\\users\\hboyina.accelaops\\desktop\\pt-ferrari\\scripts\\milwaukee\\milwaukee_tc2\\\\combined_MILWAUKEE_TC2.c" 2
...
Action()
{
	...
	lr_think_time(24);
    web_add_header("AppD_Header", "MILWAUKEE_TC2_01_Click_Addresses");
	...
	lr_end_transaction("MILWAUKEE_TC2_01_Click_Addresses",2);
    web_add_header("AppD_Header", "MILWAUKEE_TC2_02_Search_Addresses");
	...
	lr_end_transaction("MILWAUKEE_TC2_02_Search_Addresses",2);

	lr_think_time(9);
    web_add_header("AppD_Header", "MILWAUKEE_TC2_03_Click_Parcel");
	...
	lr_end_transaction("MILWAUKEE_TC2_03_Click_Parcel",2);

	lr_think_time(13);
    web_add_header("AppD_Header", "MILWAUKEE_TC2_04_Search_Parcel");
	...
	lr_end_transaction("MILWAUKEE_TC2_04_Search_Parcel",2);
    web_add_header("AppD_Header", "MILWAUKEE_TC2_05_Click_Owner");
	...
	lr_end_transaction("MILWAUKEE_TC2_05_Click_Owner",2);

	lr_think_time(8);
    web_add_header("AppD_Header", "MILWAUKEE_TC2_06_Search_Owner");
	...
	lr_end_transaction("MILWAUKEE_TC2_06_Search_Owner",2);
    web_add_header("AppD_Header", "MILWAUKEE_TC2_07_Click_LicenseProfessionals");
	...
	lr_end_transaction("MILWAUKEE_TC2_07_Click_LicenseProfessionals",2);

	lr_think_time(14);
    web_add_header("AppD_Header", "MILWAUKEE_TC2_08_Click_LicenseProfessionals_SearchTab");
	...
	lr_end_transaction("MILWAUKEE_TC2_08_Click_LicenseProfessionals_SearchTab",2);

	lr_think_time(7);
    web_add_header("AppD_Header", "MILWAUKEE_TC2_09_Search_LicenseProfessionals_Submit");
	...
	lr_end_transaction("MILWAUKEE_TC2_09_Search_LicenseProfessionals_Submit",2);

	lr_think_time(6);
    web_add_header("AppD_Header", "MILWAUKEE_TC2_10_Click_Contacts");
	...
	lr_end_transaction("MILWAUKEE_TC2_10_Click_Contacts",2);

	lr_think_time(8);
    web_add_header("AppD_Header", "MILWAUKEE_TC2_11_Click_Search_Contacts_Tab");
	...
	lr_end_transaction("MILWAUKEE_TC2_11_Click_Search_Contacts_Tab",2);

	lr_think_time(8);
    web_add_header("AppD_Header", "MILWAUKEE_TC2_12_Search_Contacts_Submit");
	...
	lr_end_transaction("MILWAUKEE_TC2_12_Search_Contacts_Submit",2);
...
# 5 "c:\\users\\hboyina.accelaops\\desktop\\pt-ferrari\\scripts\\milwaukee\\milwaukee_tc2\\\\combined_MILWAUKEE_TC2.c" 2
...
# 6 "c:\\users\\hboyina.accelaops\\desktop\\pt-ferrari\\scripts\\milwaukee\\milwaukee_tc2\\\\combined_MILWAUKEE_TC2.c" 2
