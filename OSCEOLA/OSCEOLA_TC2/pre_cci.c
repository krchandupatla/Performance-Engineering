# 1 "c:\\users\\hboyina.accelaops\\desktop\\pt-ferrari\\scripts\\osceola\\osceola_tc2\\\\combined_OSCEOLA_TC2.c"
...
# 1 "c:\\users\\hboyina.accelaops\\desktop\\pt-ferrari\\scripts\\osceola\\osceola_tc2\\\\combined_OSCEOLA_TC2.c" 2
...
# 2 "c:\\users\\hboyina.accelaops\\desktop\\pt-ferrari\\scripts\\osceola\\osceola_tc2\\\\combined_OSCEOLA_TC2.c" 2
...
# 3 "c:\\users\\hboyina.accelaops\\desktop\\pt-ferrari\\scripts\\osceola\\osceola_tc2\\\\combined_OSCEOLA_TC2.c" 2
...
# 4 "c:\\users\\hboyina.accelaops\\desktop\\pt-ferrari\\scripts\\osceola\\osceola_tc2\\\\combined_OSCEOLA_TC2.c" 2
...
Action()
{
	...
	web_custom_request("loginAction.do", 
		"URL=https://av-pt-ferrari.accela.com/ssoAdapter/loginAction.do?requestType=checkWebSSOAdapter&servProvCode=OSCEOLA_LoginOSCEOLA_Login", 
		"Method=GET", 
		"TargetFrame=", 
		"Resource=0", 
		"RecContentType=text/html", 
	...
	lr_think_time(139);
    web_add_header("AppD_Header", "OSCEOLA_TC2_01_Click_Addresses");
	lr_start_transaction("OSCEOLA_TC2_01_Click_Addresses");
	...
	web_url("session.do_5", 
		"URL=https://av-pt-ferrari.accela.com/portlets/spa/session.do?mode=activateSpace&spaceName=spaces.d7b31", 
		"TargetFrame=", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=https://av-pt-ferrari.accela.com/portlets/spa/dashboard.do", 
	...
	web_url("session.do_6", 
		"URL=https://av-pt-ferrari.accela.com/portlets/spa/session.do?mode=activateSpace&spaceName=spaces.d7b31&module=Building", 
		"TargetFrame=", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=https://av-pt-ferrari.accela.com/portlets/address/refAddressList.do?mode=Search", 
	...
	lr_end_transaction("OSCEOLA_TC2_01_Click_Addresses",2);
    web_add_header("AppD_Header", "OSCEOLA_TC2_02_Search_Addresses");
	lr_start_transaction("OSCEOLA_TC2_02_Search_Addresses");
	...
	web_submit_data("refAddressList.do_2", 
		...
		"Name=CurrentViewID", "Value=31", "ENDITEM", 
		"Name=sessionIdFromWindow", "Value=PTLdE5ygTt4AyGLDUPHiFvMG", "ENDITEM", 
		...
		"Name=value(search_range_houseNumberStart)", "Value=1000", "ENDITEM", 
	...
	lr_end_transaction("OSCEOLA_TC2_02_Search_Addresses",2);

	lr_think_time(4);
    web_add_header("AppD_Header", "OSCEOLA_TC2_03_Click_Parcel");
	lr_start_transaction("OSCEOLA_TC2_03_Click_Parcel");
	...
	web_url("session.do_14",
		"URL=https://av-pt-ferrari.accela.com/portlets/spa/session.do?mode=activateSpace&spaceName=spaces.d7b32",
		"TargetFrame=",
		"Resource=0",
		"RecContentType=application/json",
		"Referer=https://av-pt-ferrari.accela.com/portlets/spa/dashboard.do",
	...
	web_url("session.do_15",
		"URL=https://av-pt-ferrari.accela.com/portlets/spa/session.do?mode=activateSpace&spaceName=spaces.d7b32&module=Building",
		"TargetFrame=",
		"Resource=0",
		"RecContentType=application/json",
	...
	lr_end_transaction("OSCEOLA_TC2_03_Click_Parcel",2);

	lr_think_time(7);
    web_add_header("AppD_Header", "OSCEOLA_TC2_04_Search_Parcel");
	lr_start_transaction("OSCEOLA_TC2_04_Search_Parcel");
	...
	web_submit_data("refParcelList.do_2",
		...
		"Name=value(parcel*parcelNumber)", "Value=3126313289000100C0", "ENDITEM",
	...
	lr_end_transaction("OSCEOLA_TC2_04_Search_Parcel",2);
    web_add_header("AppD_Header", "OSCEOLA_TC2_05_Click_Owner");
	lr_start_transaction("OSCEOLA_TC2_05_Click_Owner");
	...
	web_url("session.do_21",
		"URL=https://av-pt-ferrari.accela.com/portlets/spa/session.do?mode=activateSpace&spaceName=spaces.d7b33",
		"TargetFrame=",
		"Resource=0",
		"RecContentType=application/json",
		"Referer=https://av-pt-ferrari.accela.com/portlets/spa/dashboard.do",
	...
	web_url("session.do_22",
		"URL=https://av-pt-ferrari.accela.com/portlets/spa/session.do?mode=activateSpace&spaceName=spaces.d7b33&module=Building",
		"TargetFrame=",
		"Resource=0",
		"RecContentType=application/json",
	...
	lr_end_transaction("OSCEOLA_TC2_05_Click_Owner",2);

	lr_think_time(11);
    web_add_header("AppD_Header", "OSCEOLA_TC2_06_Search_Owner");
	lr_start_transaction("OSCEOLA_TC2_06_Search_Owner");
	...
	web_submit_data("refOwnerList.do_2", 
		...
		"Mode=HTML", 
		"ITEMDATA", 
		"Name=TRANSACTION_TOKEN_KEY_FOR_REFOWNERLIST", "Value=cd16ccf22948b62ea6f21f9bcc0850dd", "ENDITEM", 
		...
		"Name=printType", "Value=", "ENDITEM", 
		"Name=checkBoxValue", "Value=", "ENDITEM", 
		"Name=value(refOwner*ownerFullName)", "Value=HERNANDEZ-BENITEZ JIMMY", "ENDITEM", 
	...
	web_custom_request("refOwnerForm.do",
		"URL=https://av-pt-ferrari.accela.com/portlets/owner/refOwnerForm.do?mode=viewCondition&module=Building&ownerUID=OSCEOLA%24*%24117609",
		"Method=POST",
		"TargetFrame=",
		"Resource=0",
		"RecContentType=text/html",
	...
	lr_end_transaction("OSCEOLA_TC2_06_Search_Owner",2);

	lr_think_time(4);
    web_add_header("AppD_Header", "OSCEOLA_TC2_07_Click_LicenseProfessionals");
	lr_start_transaction("OSCEOLA_TC2_07_Click_LicenseProfessionals");
	...
	web_url("session.do_31",
		"URL=https://av-pt-ferrari.accela.com/portlets/spa/session.do?mode=activateSpace&spaceName=spaces.d7b34",
		"TargetFrame=",
		"Resource=0",
		"RecContentType=application/json",
		"Referer=https://av-pt-ferrari.accela.com/portlets/spa/dashboard.do",
	...
	lr_end_transaction("OSCEOLA_TC2_07_Click_LicenseProfessionals",2);

	lr_think_time(5);
    web_add_header("AppD_Header", "OSCEOLA_TC2_08_Click_LicenseProfessionals_SearchTab");
	lr_start_transaction("OSCEOLA_TC2_08_Click_LicenseProfessionals_SearchTab");

	web_url("session.do_32",
		"URL=https://av-pt-ferrari.accela.com/portlets/spa/session.do?mode=activateSpace&spaceName=spaces.d7b34&module=Building",
		"TargetFrame=",
		"Resource=0",
		"RecContentType=application/json",
	...
	lr_end_transaction("OSCEOLA_TC2_08_Click_LicenseProfessionals_SearchTab",2);
    web_add_header("AppD_Header", "OSCEOLA_TC2_09_Search_LicenseProfessionals_Submit");
	lr_start_transaction("OSCEOLA_TC2_09_Search_LicenseProfessionals_Submit");
	...
	web_submit_data("refProfessionalList.do_3", 
		...
		"Mode=HTML", 
		"ITEMDATA", 
		"Name=TRANSACTION_TOKEN_KEY_FOR_REFPROFESSIONALLISTACTIONFORM", "Value=288f4c9680c91e6381a82a96c45410fc", "ENDITEM", 
		...
		"Name=isFilterContactAssociatedLP", "Value=null", "ENDITEM", 
		"Name=value(stateLicense)", "Value=EC13002652", "ENDITEM", 
		"Name=none", "Value=", "ENDITEM", 
		"Name=isFilterContactAssociatedLP", "Value=null", "ENDITEM", 
		...
		"Name=value(mode)", "Value=list", "ENDITEM", 
		"Name=valuetextarea5", "Value=", "ENDITEM", 
		"Name=sourcetextarea5", "Value=", "ENDITEM", 
		"Name=layouttextarea5", "Value=", "ENDITEM", 
		"Name=uiuid", "Value=5", "ENDITEM", 
	...
	lr_end_transaction("OSCEOLA_TC2_09_Search_LicenseProfessionals_Submit",2);

	lr_think_time(4);
    web_add_header("AppD_Header", "OSCEOLA_TC2_10_Click_Contacts");
	lr_start_transaction("OSCEOLA_TC2_10_Click_Contacts");
	...
	web_url("session.do_38",
		"URL=https://av-pt-ferrari.accela.com/portlets/spa/session.do?mode=activateSpace&spaceName=spaces.d7b35",
		"TargetFrame=",
		"Resource=0",
		"RecContentType=application/json",
		"Referer=https://av-pt-ferrari.accela.com/portlets/spa/dashboard.do",
	...
	web_reg_save_param_ex(
		...
		"SEARCH_FILTERS",
		"Scope=Body",
		"RequestUrl=*/refContactList.do*",
		"LAST");

	web_url("refContactList.do", 
		"URL=https://av-pt-ferrari.accela.com/portlets/contact/ref/refContactList.do?mode=quickQuery&lookup=false&value(usedQueryInfo)=Y&serviceProviderCode=OSCEOLA", 
		"TargetFrame=", 
		"Resource=0", 
		"RecContentType=text/html", 
	...
	lr_end_transaction("OSCEOLA_TC2_10_Click_Contacts",2);

	lr_think_time(4);
    web_add_header("AppD_Header", "OSCEOLA_TC2_11_Click_Search_Contacts_Tab");
	lr_start_transaction("OSCEOLA_TC2_11_Click_Search_Contacts_Tab");

	web_url("session.do_39",
		"URL=https://av-pt-ferrari.accela.com/portlets/spa/session.do?mode=activateSpace&spaceName=spaces.d7b35&module=Building",
		"TargetFrame=",
		"Resource=0",
		"RecContentType=application/json",
		"Referer=https://av-pt-ferrari.accela.com/portlets/contact/ref/refContactList.do?mode=quickQuery&lookup=false&value(usedQueryInfo)=Y&serviceProviderCode=OSCEOLA",
		"Snapshot=t80.inf",
		"Mode=HTML",
		"LAST");
	...
	lr_end_transaction("OSCEOLA_TC2_11_Click_Search_Contacts_Tab",2);

	lr_think_time(5);
    web_add_header("AppD_Header", "OSCEOLA_TC2_12_Search_Contacts_Submit");
	lr_start_transaction("OSCEOLA_TC2_12_Search_Contacts_Submit");
	...
	web_submit_data("refContactList.do_3",
		...
		"Mode=HTML",
		"ITEMDATA",
		"Name=TRANSACTION_TOKEN_KEY_FOR_REFCONTACTLISTACTIONFORM", "Value={CurrentViewID_2}b576990bcb8c292ea744d446f535a9", "ENDITEM",
		...
		"Name=value(title)", "Value=", "ENDITEM",
		"Name=value(firstName)", "Value=scott", "ENDITEM",
	...
	lr_end_transaction("OSCEOLA_TC2_12_Search_Contacts_Submit",2);
...
# 5 "c:\\users\\hboyina.accelaops\\desktop\\pt-ferrari\\scripts\\osceola\\osceola_tc2\\\\combined_OSCEOLA_TC2.c" 2
...
# 6 "c:\\users\\hboyina.accelaops\\desktop\\pt-ferrari\\scripts\\osceola\\osceola_tc2\\\\combined_OSCEOLA_TC2.c" 2
