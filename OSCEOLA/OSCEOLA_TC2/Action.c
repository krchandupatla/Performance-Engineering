...
RuleName ='AutoGeneratedRuleName_1'*/
	...
	lr_end_transaction("OSCEOLA_TC2_01_Click_Addresses",LR_AUTO);
...
//		LAST);
	...
	lr_end_transaction("OSCEOLA_TC2_02_Search_Addresses",LR_AUTO);
	...
	lr_end_transaction("OSCEOLA_TC2_03_Click_Parcel",LR_AUTO);
	...
	lr_end_transaction("OSCEOLA_TC2_04_Search_Parcel",LR_AUTO);
	...
	lr_end_transaction("OSCEOLA_TC2_05_Click_Owner",LR_AUTO);
...
/*Correlation comment: Automatic rules - Do not change!  
Original value='20027' 
Name ='CurrentViewID_1' 
Type ='Rule' 
AppName ='AA' 
RuleName ='CurrentViewID'*/
	web_reg_save_param_ex(
	...
	lr_end_transaction("OSCEOLA_TC2_06_Search_Owner",LR_AUTO);
	...
	lr_end_transaction("OSCEOLA_TC2_07_Click_LicenseProfessionals",LR_AUTO);
	...
	lr_end_transaction("OSCEOLA_TC2_08_Click_LicenseProfessionals_SearchTab",LR_AUTO);
	...
	lr_end_transaction("OSCEOLA_TC2_09_Search_LicenseProfessionals_Submit",LR_AUTO);
...
RuleName ='CurrentViewID'*/
	...
	lr_end_transaction("OSCEOLA_TC2_10_Click_Contacts",LR_AUTO);
	...
	lr_end_transaction("OSCEOLA_TC2_11_Click_Search_Contacts_Tab",LR_AUTO);
	...
	lr_end_transaction("OSCEOLA_TC2_12_Search_Contacts_Submit",LR_AUTO);
